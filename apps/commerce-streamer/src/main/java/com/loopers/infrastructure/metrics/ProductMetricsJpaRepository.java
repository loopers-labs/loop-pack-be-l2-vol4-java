...
public interface ProductMetricsJpaRepository extends JpaRepository<ProductMetricsModel, Long> {
    ...
    @Modifying
    @Query(value = "INSERT INTO product_metrics (product_id, like_count, order_count, view_count, created_at, updated_at) "
    ...
    void increaseOrderCount(@Param("productId") Long productId, @Param("quantity") Long quantity);
