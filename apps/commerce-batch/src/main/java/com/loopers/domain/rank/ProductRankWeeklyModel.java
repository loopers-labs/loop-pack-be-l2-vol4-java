...
@Entity
@Table(name = "mv_product_rank_weekly", uniqueConstraints = @UniqueConstraint(columnNames = {"period_key", "rank_no"}))
@NoArgsConstructor(access = PROTECTED)
public class ProductRankWeeklyModel extends ProductRankMv {
