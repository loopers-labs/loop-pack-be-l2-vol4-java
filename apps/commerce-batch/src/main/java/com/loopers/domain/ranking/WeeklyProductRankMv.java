...
@Table(name = "mv_product_rank_weekly",
    uniqueConstraints = {
        @UniqueConstraint(name = "uk_mv_product_rank_weekly_rank", columnNames = {"period_start_date", "rank_no"})
    },
    indexes = {
        @Index(name = "idx_mv_product_rank_weekly_period_rank", columnList = "period_start_date, rank_no")
    })
