...
public class ProductRankWeeklyMvJpaEntity extends BaseTimeEntity {
    ...
    private ProductRankWeeklyMvJpaEntity(
    ...
    public static ProductRankWeeklyMvJpaEntity from(ProductRankSnapshot snapshot) {
        return new ProductRankWeeklyMvJpaEntity(
