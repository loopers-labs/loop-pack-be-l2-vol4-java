...
class ProductFacadeTest {
    ...
    private final ProductFacade productFacade = new ProductFacade(productRepository, brandRepository, likeCountRepository, productRankRepository, productCache, eventPublisher, rankingQueryRepository);
