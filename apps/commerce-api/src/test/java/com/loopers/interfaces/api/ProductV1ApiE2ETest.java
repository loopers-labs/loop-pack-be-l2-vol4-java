...
class ProductV1ApiE2ETest {
    ...
    private Long createProduct(String name, Long brandId, int likeCount) {
        ProductModel product = productJpaRepository.save(new ProductModel(name, "설명", 1000L, 10, brandId));
    ...
    class GetList {
        ...
        void returnsFilteredProducts_whenBrandIdIsProvided() {
            ...
            assertAll(
                ...
                () -> assertThat(items).extracting(ProductV1Dto.ProductResponse::id)
                    .containsExactly(p2, p1),
                () -> assertThat(items).extracting(ProductV1Dto.ProductResponse::likeCount)
                    .containsExactly(10L, 5L),
                () -> assertThat(items).extracting(ProductV1Dto.ProductResponse::brandId)
                    .containsOnly(1L)
            );
        }
    ...
    class LikeFlow {
        ...
        private ResponseEntity<ApiResponse<ProductV1Dto.ProductResponse>> getDetail(Long productId) {
            return testRestTemplate.exchange(
