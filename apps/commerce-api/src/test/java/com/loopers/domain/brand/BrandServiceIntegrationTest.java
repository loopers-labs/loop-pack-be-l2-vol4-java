...
class BrandServiceIntegrationTest {
    ...
    class GetBrand {
        ...
        void returnsBrand_whenValidIdIsProvided() {
            BrandEntity saved = brandJpaRepository.save(new BrandEntity("브랜드", "설명"));
    ...
    class GetAllBrands {
        ...
        void excludesDeletedBrands() {
            brandJpaRepository.save(new BrandEntity("활성 브랜드", "설명"));
            BrandEntity deleted = brandJpaRepository.save(new BrandEntity("삭제 브랜드", "설명"));
            deleted.delete();
    ...
    class UpdateBrand {
        ...
        void updatesBrand_whenBrandExists() {
            BrandEntity saved = brandJpaRepository.save(new BrandEntity("원래", "원래 설명"));
