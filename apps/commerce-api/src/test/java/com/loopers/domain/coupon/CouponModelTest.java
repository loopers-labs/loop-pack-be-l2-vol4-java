...
class CouponModelTest {
    ...
    class Create {
        ...
        void throwsBadRequest_whenNameIsNull() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel(null, CouponType.FIXED, 1000, null, FUTURE, null));
        ...
        void throwsBadRequest_whenNameIsBlank() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("  ", CouponType.FIXED, 1000, null, FUTURE, null));
        ...
        void throwsBadRequest_whenTypeIsNull() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", null, 1000, null, FUTURE, null));
        ...
        void throwsBadRequest_whenValueIsZeroOrNegative() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.FIXED, 0, null, FUTURE, null));
        ...
        void throwsBadRequest_whenRateCouponValueExceeds100() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.RATE, 101, null, FUTURE, null));
        ...
        void throwsBadRequest_whenExpiredAtIsNull() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.FIXED, 1000, null, null, null));
        ...
        void throwsBadRequest_whenMinOrderAmountIsZero() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.FIXED, 1000, 0, FUTURE, null));
        ...
        void throwsBadRequest_whenMinOrderAmountIsNegative() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.FIXED, 1000, -1, FUTURE, null));
        ...
        void createsCoupon_whenMinOrderAmountIsNull() {
            CouponModel coupon = new CouponModel("할인쿠폰", CouponType.FIXED, 1000, null, FUTURE, null);
        ...
        void createsCoupon_whenMinOrderAmountIsPositive() {
            CouponModel coupon = new CouponModel("할인쿠폰", CouponType.FIXED, 1000, 5000, FUTURE, null);

            assertThat(coupon).isNotNull();
        }

        @DisplayName("totalQuantity가 0이면 BAD_REQUEST 예외가 발생한다.")
        @Test
        void throwsBadRequest_whenTotalQuantityIsZero() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.FIXED, 1000, null, FUTURE, 0));

            assertThat(result.getErrorType()).isEqualTo(ErrorType.BAD_REQUEST);
        }

        @DisplayName("totalQuantity가 음수이면 BAD_REQUEST 예외가 발생한다.")
        @Test
        void throwsBadRequest_whenTotalQuantityIsNegative() {
            CoreException result = assertThrows(CoreException.class,
                () -> new CouponModel("할인쿠폰", CouponType.FIXED, 1000, null, FUTURE, -1));

            assertThat(result.getErrorType()).isEqualTo(ErrorType.BAD_REQUEST);
        }

        @DisplayName("totalQuantity가 null이면 수량 제한 없이 생성되고 issuedQuantity는 0이다.")
        @Test
        ...
        @DisplayName("totalQuantity가 양수이면 선착순 수량 제한과 함께 생성된다.")
        @Test
        void createsLimitedCoupon_whenTotalQuantityIsPositive() {
            CouponModel coupon = new CouponModel("선착순쿠폰", CouponType.FIXED, 1000, null, FUTURE, 100);
    ...
    class CalculateDiscount {
        ...
        void returnsFixedDiscount() {
            CouponModel coupon = new CouponModel("정액쿠폰", CouponType.FIXED, 3_000, null, FUTURE, null);
        ...
        void capsDiscountAtOrderAmount_whenFixedValueExceedsOrderAmount() {
            CouponModel coupon = new CouponModel("정액쿠폰", CouponType.FIXED, 50_000, null, FUTURE, null);
        ...
        void returnsRateDiscount() {
            CouponModel coupon = new CouponModel("정률쿠폰", CouponType.RATE, 10, null, FUTURE, null);
        ...
        void throwsBadRequest_whenOrderAmountBelowMinimum() {
            CouponModel coupon = new CouponModel("최소금액쿠폰", CouponType.FIXED, 1_000, 10_000, FUTURE, null);
    ...
    class IsExpired {
        ...
        void returnsTrue_whenExpiredAtIsInPast() {
            CouponModel coupon = new CouponModel("만료쿠폰", CouponType.FIXED, 1_000, null, PAST, null);
        ...
        void returnsFalse_whenExpiredAtIsInFuture() {
            CouponModel coupon = new CouponModel("유효쿠폰", CouponType.FIXED, 1_000, null, FUTURE, null);
