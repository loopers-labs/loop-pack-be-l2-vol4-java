...
class UserModelTest {
    ...
    class ValidateRawPassword {
        ...
        void passes_whenPasswordIsValid() {
            ...
            LocalDate birthDate = LocalDate.of(2002, 5, 11);

            // when / then
            assertDoesNotThrow(() -> UserModel.validateRawPassword(password, birthDate));
        }
        ...
        void throwsBadRequest_whenPasswordIsTooShort() {
            ...
            // when
            CoreException ex = assertThrows(CoreException.class, () ->
                UserModel.validateRawPassword(password, VALID_BIRTH_DATE)
            );
        ...
        void throwsBadRequest_whenPasswordContainsFullYear() {
            ...
            // when
            CoreException ex = assertThrows(CoreException.class, () ->
                UserModel.validateRawPassword(password, birthDate)
            );
