...
public interface OrderV1ApiSpec {
    ...
    @Operation(
        summary = "주문 생성",
        description = "헤더로 식별한 유저가 여러 상품을 주문합니다. 재고를 차감합니다. "
            + "대기열 게이트가 켜져 있으면 X-Loopers-EntryToken 헤더의 입장 토큰을 검증합니다."
    )
    ApiResponse<OrderV1Dto.OrderResponse> createOrder(AuthHeaders auth, String entryToken, OrderV1Dto.CreateOrderRequest request);
