...
public class ProductV1Controller implements ProductV1ApiSpec {
    ...
    public ApiResponse<ProductV1Dto.ProductResponse> getProduct(
        ...
        // 순위는 계속 바뀌므로 캐시된 상품 정보와 분리해 매 요청마다 따로 조회한다.
        Long rank = rankingFacade.getRank(LocalDate.now(), productId).orElse(null);
        return ApiResponse.success(ProductV1Dto.ProductResponse.from(productFacade.getProduct(productId), rank));
    }
