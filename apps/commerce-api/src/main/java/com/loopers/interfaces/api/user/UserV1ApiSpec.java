...
public interface UserV1ApiSpec {
    ...
    ApiResponse<UserV1Dto.MyInfoResponse> getMyInfo(UserModel user);

    @Operation(summary = "비밀번호 변경", description = "인증된 회원의 비밀번호를 변경합니다.")
    ApiResponse<Void> changePassword(UserModel user, @Valid UserV1Dto.ChangePasswordRequest request);
}
