...
public interface BrandV1ApiSpec {
    ...
    ApiResponse<BrandV1Response.Detail> create(@Valid BrandV1Request.Create request);
    ...
    ApiResponse<BrandV1Response.Detail> update(Long brandId, @Valid BrandV1Request.Update request);
