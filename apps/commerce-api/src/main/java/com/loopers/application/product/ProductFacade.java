...
import com.loopers.application.event.ProductActivityEventPublisher;
...
public class ProductFacade {
  ...
  public ProductInfo getProduct(Long id) {
    ...
    if (cached.isPresent()) {
      ProductInfo info = cached.get();
      activityEventPublisher.publishViewed(id);
      return info;
    }
  ...
  public ProductInfo updateProduct(
    ...
    ProductModel product =
        productService.updateProduct(id, name, description, price, stock, brandId);
